...
# 2. PŘIDÁNÍ SOUBORŮ
# Tady seznam všech důležitých souborů. Když přidáš nový, dopiš ho sem.
...
# --- Hlavní React soubory ---
add_file "src/main.jsx" "javascript"
add_file "src/App.jsx" "javascript"
add_file "src/index.css" "css"
add_file "src/firebaseConfig.js" "javascript"

# --- Komponenty ---
add_file "src/components/CustomerView.jsx" "javascript"
add_file "src/components/AdminView.jsx" "javascript"

# --- Logika a Utils ---
add_file "src/utils/helpers.js" "javascript"

# --- TESTY (Nově přidáno) ---
add_file "src/setupTests.js" "javascript"
add_file "src/utils/helpers.test.js" "javascript"
