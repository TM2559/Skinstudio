...
export const WEB_CONTENT = {
  ...
  footer: {
    ...
    location: 'Masarykovo náměstí 72 (Budova ČSOB – 2. patro)',
    locationWithTown: 'Masarykovo náměstí 72 (Budova ČSOB – 2. patro), Uherský Brod',
  ...
  pmuPage: {
    ...
    footer: {
      ...
      navRezervace: 'Rezervace',
      contactHeading: 'Kontakt',
      location: 'Masarykovo náměstí 72 (Budova ČSOB – 2. patro), Uherský Brod',
      email: 'lucie@skinstudio.cz',
      phone: '+420 724 875 558',
