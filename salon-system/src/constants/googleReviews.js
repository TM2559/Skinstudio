export const GOOGLE_REVIEWS = [
  {
    "id": "g1",
    "name": "Žaneta Brezaniova",
    "roleOrDate": "před 5 měsíci",
    "rating": 5,
    "text": "Skin Studio Lucie Metelkové je doslova oázou klidu v dnešní uspěchané době. Jakmile vstoupíte dovnitř, zpomalíte, zklidníte se a necháte starosti za dveřmi. Hned při příchodu vás přivítá milý úsměv a často i nabídka voňavé kávy, díky které se budete cítit opravdu jako v bavlnce.\n\nMajitelka je nejen velmi milá, ale také velmi profesionální.  Řeší každý detail a je vidět, že je perfekcionistka v tom nejlepším slova smyslu.  Nevyužívá univerzální řešení, naopak ke každé klientce přistupuje individuálně. Nehoní čas, nesleduje hodinky. Jejím cílem je, aby byl výsledek naprosto dokonalý. Díky tomu řasy vydrží natočené klidně několik měsíců. Každý, kdo ode mě dostal k Lucce poukaz jako dárek, byl spokojený.\n\nVelmi si cením i přístupu během ošetření. Dokáže citlivě vnímat, jak se cítíte. Umí příjemně komunikovat, ale zároveň pozná, kdy chcete jen v klidu relaxovat a užívat si ticho a relaxační hudbu.\nVždy se snaží vyjít vstříc s termínem, klidně i v méně obvyklý den nebo  čas.\n\nK tomu všemu krásné prostředí. Pokud hledáte místo, kde si opravdu odpočinete a kde o vás bude skvěle postaráno, tohle studio mohu jedině doporučit.\n\nAle pozor! Na toto místo si lze vypěstovat závislost!"
  },
  {
    "id": "g2",
    "name": "Aneta Zelová",
